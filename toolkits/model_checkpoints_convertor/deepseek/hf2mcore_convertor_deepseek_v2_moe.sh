...
CONVERTOR_DIR=$( dirname ${CURRENT_DIR})
...
#SOURCE_CKPT_PATH=${ROOT_DIR}/../model/DeepSeek-V2-Lite
#TARGET_CKPT_PATH=${ROOT_DIR}/../ckpt/DeepSeek-V2-Lite-mcore-TP-${TP}-PP-${PP}-EP-${EP}
HF_CKPT_PATH=${LOAD}
SOURCE_CKPT_PATH=${LOAD}
TARGET_CKPT_PATH=${SAVE}
